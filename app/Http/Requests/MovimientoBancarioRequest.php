...
class MovimientoBancarioRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'tipo.in'                   => 'Tipo inválido. Use: Deposito, Retiro, Transferencia, Comision o Interes.',
            'monto.required'            => 'El monto es obligatorio.',
            'monto.min'                 => 'El monto debe ser mayor a 0.',
            'fecha_movimiento.required' => 'La fecha del movimiento es obligatoria.',
            'fecha_movimiento.date'     => 'La fecha no tiene un formato válido.',
        ];
    }
